...
public class ShadowLayout1 extends FrameLayout {
    ...
    public ShadowLayout1(final Context context) {
        this(context, null);
    }

    public ShadowLayout1(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShadowLayout1(final Context context, final AttributeSet attrs, final int defStyleAttr) {
